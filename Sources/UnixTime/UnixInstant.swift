public protocol UnixInstant<Duration>: InstantProtocol {
...
extension UnixInstant {
    @inlinable public static func - (after: Self, before: Self) -> Duration {
        before.duration(to: after)
    }

    @inlinable public static func - (self: Self, duration: Duration) -> Self {
...
extension UnixInstant {
    @inlinable public static func -= (self: inout Self, duration: Duration) {
        self = self - duration
    }
