...
@frozen public struct UnixAttosecond: Equatable, Hashable, Sendable {
    public var second: Int64
    public let attoseconds: Int64

    @inlinable init(second: Int64, attoseconds: Int64) {
        self.second = second
...
extension UnixAttosecond {
    ...
    /// interval.
    @inlinable public init(_ millisecond: UnixMillisecond) {
    ...
    @inlinable public static func second(_ second: Int64) -> Self {
        .init(second: second, attoseconds: 0)
    }
    ...
    @inlinable public static func second(_ second: Int64, attoseconds: Int64) -> Self {
        precondition(
            0 ..< 1_000_000_000_000_000_000 ~= attoseconds,
...
extension UnixAttosecond {
    @inlinable func advanced(by components: (seconds: Int64, attoseconds: Int64)) -> Self {
...
extension UnixAttosecond: UnixInstant {
    ...
    @inlinable public static var zero: Self { .init(second: 0, attoseconds: 0) }

    @inlinable public func regressed(by duration: Duration) -> Self {
        self.advanced(by: (-duration.components.seconds, -duration.components.attoseconds))
    }

    @inlinable public func advanced(by duration: Duration) -> Self {
        self.advanced(by: duration.components)
    }

    @inlinable public func duration(to after: Self) -> Duration {
