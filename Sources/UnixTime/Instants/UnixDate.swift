...
extension UnixDate: Strideable {
    @inlinable public func advanced(by days: Int64) -> Self { self.advanced(by: .days(days)) }

    @inlinable public func distance(to day: Self) -> Int64 { self.duration(to: day).count }
}
